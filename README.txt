...
From your Moodle theme directory right click on sparkle and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of sparkle.
...
underscores. For the purpose of this tutorial we will call the theme 'sparkletheme'.

On opening 'sparkletheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case sparkle. So using the above list as
a guide, search through and change all the instances of the theme name
'sparkle' to 'sparkletheme'. This includes the filename of the lang/en/theme_sparkle.php.
You need to change this to 'theme_sparkletheme.php'.
