...
include ('includes/theme_alerts.php');
// include ('includes/theme_slider.php'); This line is left in so if a school or institution uses MyHome as its user home page they may decide to implement the slider there
